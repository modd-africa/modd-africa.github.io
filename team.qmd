...
<div class="team team-grid">
  ...
  <div class="person" data-group="regional">
    ...
    <h3>Sosthenes Ketende</h3><p class="role">Programme Manager</p>
  </div>
  <div class="person" data-group="regional">
  ...
  <div class="person" data-group="regional">
    ...
    <h3>Samson Kiware</h3><p class="role">Mathematical Modelling</p>
  </div>
  ...
  <div class="person" data-group="tanzania">
    ...
    <h3>Kaiza Kunonu</h3><p class="role">Evidence Synthesis Lead</p><p class="org">Tanzania</p>
  </div>
  ...
  <div class="person" data-group="nigeria">
    ...
    <h3>Babalola Ayodele</h3><p class="role">Senior Modeller</p><p class="org">Nigeria</p>
  </div>
...
<div class="hubcards">
  ...
  <div class="hubcard">
    ...
    <div class="hubcard__body">
      ...
      <h3>DR Congo — INRB</h3>
      <p>Extends the modelling work to one of the highest-burden malaria settings on the continent, from the National Institute for Biomedical Research.</p>
    </div>
  </div>
  <div class="hubcard">
